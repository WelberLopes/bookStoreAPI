...
async function connectDataBase() {
  ...
  const connectionString = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}@nodejs-bookstore.fh9rq.mongodb.net/?retryWrites=true&w=majority&appName=${process.env.DB_DATABASE}'`;
  ...
  //mongodb+srv://dev:45052120@cluster0.gt5fv.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0

  //mongodb+srv://jadson:a3sistemasdistribuidos@nodejs-bookstore.fh9rq.mongodb.net/?retryWrites=true&w=majority&appName=nodejs-bookstore
